...
const columns: TableColumn<CursoData>[] = [
  ...
  },
  {
    ...
    name: "Detalhes",
    cell: (row) => (
      <Link to={`/detalhes-estudante-outras_formacoes`}>
          ...
          <div className="row">
              <div className="col-12">
                  <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                      <h4 className="mb-sm-0">Estudantes de Formação Especializada</h4>

                      <div>
                        <Link to="/registar-estudante-outras_formacoes">
...
export default OutrasFormacoes;
