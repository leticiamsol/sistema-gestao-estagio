                ...
                <div className="container-fluid">
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0" style={alignDiv}>
                                        ...
                                        <li className="breadcrumb-item active">Registar Empresa</li>
                                    </ol>
                                </div>
                    ...
                    <form method="" action="" className="row">
                        ...
                        <div className="card-body" id="form-table" style={backGround}>
                            ...
                            <h4 className="mb-sm-0">Registar Empresa</h4>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='distrito' id="ingredientes-input">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='concelho' id="ingredientes-input">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='freguesia' id="ingredientes-input">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='area' id="ingredientes-input">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <textarea name="descricao" id="textarea" className="form-control" style={{ height: '120px' }}></textarea>
                                </div>
                            </div>

                            <input
                                type="submit"
                                value="Registar Empresa"
