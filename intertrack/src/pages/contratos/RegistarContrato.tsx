                ...
                <div className="container-fluid">
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0" style={alignDiv}>
                                        ...
                                        <li className="breadcrumb-item active">Registar Contrato</li>
                                    </ol>
                                </div>
                    ...
                    <form method="" action="" className="row">
                        ...
                        <div className="card-body" id="form-table" style={backGround}>
                            ...
                            <h4 className="mb-sm-0">Registar Contrato</h4>

                            <div className="row mb-3">
                                <label htmlFor="tipo-refeicao-input" className="col-sm-2 col-form-label">Estudante</label>
                                <div className="col-sm-10">
                                    <select className="form-control" name='estudante_id' id="ingredientes-input">
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='empresa_id' id="ingredientes-input">
                                        <option value="">Selecionar</option>   
