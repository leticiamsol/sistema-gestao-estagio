                ...
                <div className="container-fluid">
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0" style={alignDiv}>
                                        <li><Link to="/estagio" style={{ color: '#6d757d', marginLeft: '3px' }} className='curso-link'>Estágios</Link></li>
                                        <li>
                                            <FontAwesomeIcon icon={faChevronRight} style={{ color: '#6D757D', fontSize: '12px' }}/>
                                        </li>
                                        <li className="breadcrumb-item active">Detalhes do Estágio</li>
                                    </ol>
                                </div>
                    ...
                    <form method="" action="" className="row">
                        ...
                        <div className="card-body" id="form-table" style={backGround}>
                            ...
                            <h4 className="mb-sm-0">Atualizar Estágio</h4>
                            ...
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-10">
                                    <select className="form-control" name='nivel' id="ingredientes-input" disabled>
